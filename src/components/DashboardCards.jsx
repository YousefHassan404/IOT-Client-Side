...
export default function DashboardCards({ latest, stats, total, deviceControls, thresholds }) {
  const cards = [
    {
      title: 'Temperature',
        ...
        {cards.map((card, index) => (
          ...
          >
            <div className="card-content">
              ...
              {card.type === 'gas' ? (
                <GasGauge value={card.value} thresholds={thresholds} />
              ) : (
